...
// Email HTML generated by Outlook/Zoho can contain well over 100 redundant wrapper elements.
// Keep a finite recursion guard while avoiding silent truncation of otherwise valid content.
pub(crate) const NATIVE_STACK_SAFE_DEPTH: usize = 256;
